...
- Audit candidate tag: `audit-candidate-0.1.0-20260613-snapper-guard`
- Audit candidate commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260613-snapper-guard`
...
- Security contact or process: https://github.com/DUCAT-UNIT/ducat-snap/blob/audit-candidate-0.1.0-20260613-snapper-guard/SECURITY.md
- Security source: `SECURITY.md`
- Privacy policy URL: https://github.com/DUCAT-UNIT/ducat-snap/blob/audit-candidate-0.1.0-20260613-snapper-guard/PRIVACY.md
