...
- Tag: `audit-candidate-0.1.2-20260614-audit-review-fixes`
- Commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.2-20260614-audit-review-fixes`
...
10. Publish `@ducat-unit/wallet-snap@0.1.2` to npm after audit fixes are merged.
