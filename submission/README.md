...
- Tag: `audit-candidate-0.1.0-20260614-package-allowlist`
- Commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260614-package-allowlist`
