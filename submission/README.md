...
- Tag: `audit-candidate-0.1.0-20260613-confirmation-surface-polish`
- Commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260613-confirmation-surface-polish`
