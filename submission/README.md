...
- Tag: `audit-candidate-0.1.3-20260614-capability-harness-fix`
- Commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.3-20260614-capability-harness-fix`
- Verification evidence: run the `Verify Ducat Snap` workflow after pushing the candidate branch
...
10. Publish `@ducat-unit/wallet-snap@0.1.3` to npm after audit fixes are merged.
