...
- Implementation tag: `audit-candidate-0.1.0-20260614-snapper-cleanup`
- Implementation commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260614-snapper-cleanup`
...
- Send `audit-candidate-0.1.0-20260614-snapper-cleanup` to the external Snap auditor.
