...
- Implementation tag: `audit-candidate-0.1.0-20260613-ci-tag-fetch`
- Implementation commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260613-ci-tag-fetch`
...
- Send `audit-candidate-0.1.0-20260613-ci-tag-fetch` to the external Snap auditor.
