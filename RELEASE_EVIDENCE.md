...
- Implementation tag: `audit-candidate-0.1.0-20260613-pr-head-tag-guard`
- Implementation commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260613-pr-head-tag-guard`
...
- Send `audit-candidate-0.1.0-20260613-pr-head-tag-guard` to the external Snap auditor.
