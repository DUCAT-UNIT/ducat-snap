...
- [x] Audit candidate tag exists: `audit-candidate-0.1.4-20260614-docs-cleanup`.
...
- [x] `@ducat-unit/wallet-snap@0.1.4` release metadata prepared for npm publication.
- [ ] Frontend PR #675 default Snap version range updated to `^0.1.4`.
...
- [ ] Signet/mutinynet install, connect, create, deposit, borrow, repay, withdraw, swap, liquidation, and repossess E2E scenarios pass.
