...
- Audit candidate tag: `audit-candidate-0.1.0-20260614-snapper-cleanup`
- Audit candidate commit: resolve from the tag with `git rev-list -n 1 audit-candidate-0.1.0-20260614-snapper-cleanup`
